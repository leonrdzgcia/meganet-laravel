    ...
    'Voise' => [
        'FIELDS' => [
            ...
            'type' => [
                ...
                'value' => null,
                'options' => ['VoIP' => 'Telefonía IP', 'Corregido' => 'Corregido', 'Móvil' => 'Telefonía Móvil'],
                'position' => 6
            ],
            'partners' => [
                'label' => 'Socios',
            ...
            'transaction_category_for_calls' => [
                'label' => 'Categoria de Transacción de Llamadas',
                'placeholder' => 'Seleccione la categoría',
                'type' => 'select-component',
                'value' => null,
                'options' => ['Servicio' => "Servicio", 'Descuento' => "Descuento", 'Pago' => "Pago", 'Reembolso' => "Reembolso", 'Corrección' => "Corrección"],
            ...
            'transaction_category_for_messages' => [
                'label' => 'Categoria de Transacción de Mensajes',
                'placeholder' => 'Seleccione la categoría',
                'type' => 'select-component',
                'value' => null,
                'options' => ['Servicio' => "Servicio", 'Descuento' => "Descuento", 'Pago' => "Pago", 'Reembolso' => "Reembolso", 'Corrección' => "Corrección"],
            ...
            'transaction_category_for_data' => [
                'label' => 'Categoria de Transacción de Datos',
                'placeholder' => 'Seleccione la categoría',
                'type' => 'select-component',
                'value' => null,
                'options' => ['Servicio' => "Servicio", 'Descuento' => "Descuento", 'Pago' => "Pago", 'Reembolso' => "Reembolso", 'Corrección' => "Corrección"],
        ...
        'DATATABLE_FIELDS' => [
            ...
            'transaction_category_for_calls' => [
                'name' => 'Categoria de Transacción de Llamadas',
                'class' => null
            ],
            'transaction_category_for_messages' => [
                'name' => 'Categoria de Transacción de Mensajes',
                'class' => null
            ],
            'transaction_category_for_data' => [
                'name' => 'Categoria de Transacción de Datos',
                'class' => null
            ],
            'available_in_self_registration' => [
