...
class RemoveNomenclatureToClientAdditionalInformation extends Migration
{
    /**
     * Run the migrations.
     *
...
//        $module->fields()->where('name','nomenclature')->first()->delete();
    ...
    {
        Schema::table('client_additional_information', function (Blueprint $table) {
            $table->string('nomenclature')->nullable()->after('password_wifi');
        });
