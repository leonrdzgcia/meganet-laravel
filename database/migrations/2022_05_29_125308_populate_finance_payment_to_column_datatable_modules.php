...
class PopulateFinancePaymentToColumnDatatableModules extends Migration
{
      /**
         * Run the migrations.
         *
        ...
        public function up()
        {
            ...
            $module = Module::create(['name' => 'FinancePayment']);
            $module->packages()->attach($bootstrap_multiselect_toaster_datatables_packages);
            $module->fields()->delete();
            $module->columnsDatatable()->insert($this->transformColumnsDatatableModel('module.finance.payment.constants.', $module));
        }
        ...
        {
            $module = Module::where('name', 'FinancePayment')->first();
