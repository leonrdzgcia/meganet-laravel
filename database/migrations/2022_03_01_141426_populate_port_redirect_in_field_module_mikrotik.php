...
class PopulatePortRedirectInFieldModuleMikrotik extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
         $field_module = \App\Models\FieldModule::find(426);
         $field_module->update(
    ...
    public function down()
    {
        ...
        \App\Models\FieldModule::where('name','port_redirect')->delete();
    }
}
