...
class PopulateClientInvoiceToFieldModule extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $module = Module::create(['name' => 'ClientInvoice']);
        $module->packages()->attach($bootstrap_multiselect_toaster_datatables_packages);
        $module->fields()->insert($this->transformFieldsModel('module.client.billing.invoice.constants.', $module));
        $module->columnsDatatable()->insert($this->transformColumnsDatatableModel('module.client.billing.invoice.constants.', $module));

        $module = Module::where('name', 'ClientInvoice')->first();
