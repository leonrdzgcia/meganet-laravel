...
class PopulateFinanceInvoiceToColumnDatatableModules extends Migration
{
        ...
        public function up()
        {
            ...
            $module = Module::create(['name' => 'FinanceInvoice']);
            $module->packages()->attach($bootstrap_multiselect_toaster_datatables_packages);
            $module->fields()->delete();
            $module->columnsDatatable()->insert($this->transformColumnsDatatableModel('module.finance.invoice.constants.', $module));
        }
        ...
        {
            $module = Module::where('name', 'FinanceInvoice')->first();
